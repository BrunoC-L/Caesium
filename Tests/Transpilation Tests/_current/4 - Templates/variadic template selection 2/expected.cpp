...
Int _redirect_main(const Vector_String_& args) {
	...
	A_Int_String_Floating_ d = A_Int_String_Floating_{1, String{"hello"}, (1 + 3.141592)};
	A_Int_String_Floating_ d = A_Int_String_Floating_{1, String{"hello"}, (3.141592 - 1)};
	A_Int_String_Floating_ e = A_Int_String_Floating_{1, String{"hello"}, (3.141592 - 2.71828)};
	Int f = { 7 }; 
	A_Int_String_Floating_ e = A_Int_String_Floating_{1, String{"hello"}, f};
}
