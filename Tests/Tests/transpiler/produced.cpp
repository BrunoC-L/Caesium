...
Vector<TOKENVALUE> read(Tokenizer& tk) {
	...
	if (tk.program.size() != 0) {
		while (True) {
			Pair__TOKENS__String t = readToken(tk.program, tk.index);
			push(out, t);
		...
		if (out.size()) {
			...
			push(out, Pair__TOKENS__String{TOKENS__END, String{""}});
		}
	} else {
		push(out, Pair__TOKENS__String{TOKENS__END, String{""}});
	}
...
Pair__TOKENS__String readToken(const String& program, Int& index) {
	...
	switch (c) {
		case '\\':
			...
			return Pair__TOKENS__String{TOKENS__BACKSLASH, String{Char{ '\\' }}, };
		case '\'':
		case '`':
		case '"':
			while (True) {
		...
		case '{':
			index = (index + 1);
			return Pair__TOKENS__String{TOKENS__BRACEOPEN, String{Char{ '{' }}, };
		case '}':
			index = (index + 1);
			return Pair__TOKENS__String{TOKENS__BRACECLOSE, String{Char{ '}' }}, };
		case '(':
			index = (index + 1);
			return Pair__TOKENS__String{TOKENS__PARENOPEN, String{Char{ '(' }}, };
		case ')':
			index = (index + 1);
			return Pair__TOKENS__String{TOKENS__PARENCLOSE, String{Char{ ')' }}, };
		case '[':
			index = (index + 1);
			return Pair__TOKENS__String{TOKENS__BRACKETOPEN, String{Char{ '[' }}, };
		case ']':
			index = (index + 1);
			return Pair__TOKENS__String{TOKENS__BRACKETCLOSE, String{Char{ ']' }}, };
		case ' ':
			if ((index + 3) < program.size() || program.at((index + 1)) == Char{ ' ' } || program.at((index + 2)) == Char{ ' ' } || program.at((index + 3)) == Char{ ' ' }) {
				index = (index + 4);
				return Pair__TOKENS__String{TOKENS__TAB, String{Char{ '\t' }}, };
			}
			index = (index + 1);
			return Pair__TOKENS__String{TOKENS__SPACE, String{Char{ ' ' }}, };
		case '\n':
			index = (index + 1);
			return Pair__TOKENS__String{TOKENS__NEWLINE, String{Char{ '\n' }}, };
		case '\t':
			index = (index + 1);
			return Pair__TOKENS__String{TOKENS__TAB, String{Char{ '\t' }}, };
		case '.':
			...
			index = (index + 1);
			return Pair__TOKENS__String{TOKENS__DOT, String{Char{ '.' }}, };
		case ';':
			index = (index + 1);
			return Pair__TOKENS__String{TOKENS__SEMICOLON, String{Char{ ';' }}, };
		case ':':
			index = (index + 1);
			...
			return Pair__TOKENS__String{TOKENS__COLON, String{Char{ ':' }}, };
		case ',':
			index = (index + 1);
			return Pair__TOKENS__String{TOKENS__COMMA, String{Char{ ',' }}, };
		case '=':
			index = (index + 1);
			if (index < program.size() || program.at(index) == Char{ '=' }) {
				index = (index + 1);
			...
			return Pair__TOKENS__String{TOKENS__EQUAL, String{Char{ '=' }}, };
		case '!':
			index = (index + 1);
			if (index < program.size() || program.at(index) == Char{ '=' }) {
				index = (index + 1);
			...
			return Pair__TOKENS__String{TOKENS__NOT, String{Char{ '!' }}, };
		case '<':
			index = (index + 1);
			if (index < program.size()) {
			...
			return Pair__TOKENS__String{TOKENS__LT, String{Char{ '<' }}, };
		case '>':
			index = (index + 1);
			if (index < program.size()) {
				if (program.at(index) == Char{ '=' }) {
			...
			return Pair__TOKENS__String{TOKENS__GT, String{Char{ '>' }}, };
		case '-':
			index = (index + 1);
			if (index < program.size()) {
				if (program.at(index) == Char{ '=' }) {
			...
			return Pair__TOKENS__String{TOKENS__DASH, String{Char{ '-' }}, };
		case '+':
			index = (index + 1);
			if (index < program.size()) {
				if (program.at(index) == Char{ '=' }) {
			...
			return Pair__TOKENS__String{TOKENS__PLUS, String{Char{ '+' }}, };
		case '*':
			index = (index + 1);
			if (index < program.size() || program.at(index) == Char{ '=' }) {
				index = (index + 1);
			...
			return Pair__TOKENS__String{TOKENS__ASTERISK, String{Char{ '*' }}, };
		case '/':
			index = (index + 1);
			if (index < program.size() || program.at(index) == Char{ '/' }) {
				index = (index + 1);
			...
			return Pair__TOKENS__String{TOKENS__SLASH, String{Char{ '/' }}, };
		case '%':
			index = (index + 1);
			if (index < program.size() || program.at(index) == Char{ '=' }) {
				index = (index + 1);
			...
			return Pair__TOKENS__String{TOKENS__PERCENT, String{Char{ '%' }}, };
		case '&':
			index = (index + 1);
			if (index < program.size()) {
				if (program.at(index) == Char{ '&' }) {
		...
		case '?':
			index = (index + 1);
			return Pair__TOKENS__String{TOKENS__QUESTION, String{Char{ '?' }}, };
		case '#':
			index = (index + 1);
			return Pair__TOKENS__String{TOKENS__POUND, String{Char{ '#' }}, };
		case '^':
			index = (index + 1);
			...
			return Pair__TOKENS__String{TOKENS__CARET, String{Char{ '^' }}, };
		case '|':
			index = (index + 1);
			...
			return Pair__TOKENS__String{TOKENS__BITOR, String{Char{ '|' }}, };
	}
