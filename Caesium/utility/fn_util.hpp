...
#define LIFT(...) [&](auto&&... e) { return __VA_ARGS__(FORWARD(e)...); }
...
#define LIFT_FILTER_TRAIL(...) std::views::filter([&](auto&& e) { return e __VA_ARGS__ ; })
#define LIFT_TRANSFORM_TRAIL(...) std::views::transform([&](auto&& e) { return e __VA_ARGS__ ; })
