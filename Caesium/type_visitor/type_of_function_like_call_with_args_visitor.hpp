...
struct type_of_function_like_call_with_args_visitor : TypeCategoryVisitor<type_of_function_like_call_with_args_visitor> {
	...
	using R = expected<std::pair<NodeStructs::ValueCategory, Realised::MetaType>>;

	TypeCategoryVisitorDeclarations
};

expected<std::pair<NodeStructs::ValueCategory, Realised::MetaType>> type_of_function_like_call_with_args(
	transpilation_state_with_indent state,
	variables_t& variables,
